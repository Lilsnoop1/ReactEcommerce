...
function Description(props){
    ...
    if (producttype==="watch"){
        ...
        return <div>
            ...
            id={watchClicked.id} openCart={handleClick} homesetter={props.setHomeKart} paramVal={{id:productid,type:producttype}}  
            />
        </div>
        ...
        return <div>
            ...
            title={braceletClicked.Title} id={braceletClicked.id} paramVal={{id:productid,type:producttype}}
        ...
        return <div>
            ...
            title={ringClicked.Title} id={ringClicked.id} paramVal={{id:productid,type:producttype}}
            openCart={handleClick} homesetter={props.setHomeKart} />
        </div>
    }
}
